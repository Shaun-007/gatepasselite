...
// Default is same origin: the backend is served by the same Node/Express app
// (npm start) or proxied in dev (Vite). This makes the demo run fully locally.
const DEFAULT_API_BASE_URL = '';

export function getApiBaseUrl() {
  return window.API_BASE_URL || localStorage.getItem('API_BASE_URL') || DEFAULT_API_BASE_URL;
}
